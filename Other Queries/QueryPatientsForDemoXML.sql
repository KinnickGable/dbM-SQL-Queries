...
DROP TABLE #EncountersCount
DROP TABLE #DiagnosesCount
DROP TABLE  #AllergiesCount
DROP TABLE  #ProblemsCount
DROP TABLE  #ImmunizationsCount
DROP TABLE  #MedicationsCount
DROP TABLE  #LabEventsCount
DROP TABLE  #ImagingCount
DROP TABLE  #ProceduresCount
DROP TABLE  #DocumentsCount
...
Insert into #PatientForDemoRepositiory_Raw(PatientRecordID,PrimaryIDExtension,PrimaryIDRoot ,
	  PrimaryIdAssigningAuthority , BirthTime,AdministrativeGenderCode,FirstName,
	   LastName,Phone ,Street,City ,"State" ,Zip,SSN )
Select 
	...
	,apSAL.value,apCTY.value, apValCodeSTA.ConceptCode,apZIP.value as ZIP,Null
	--,pridSSN.Extension as SSN
...
Select * from 
	#PatientForDemoRepositiory_Raw inner join
		#ActsCount on #PatientForDemoRepositiory_Raw.PatientRecordID=#ActsCount.PatientRecordId
--where
	--#ActsCount.EncountersCount>0
	--and #ActsCount.AllergiesCount>0
...
DROP TABLE  #ActsCount
DROP TABLE #PatientForDemoRepositiory_Raw
